...
public class HotelFinal extends javax.swing.JFrame  {
    ...
    public static java.sql.Connection connection(){ 
        ...
        try {  
            ...
            System.out.println("You are now connected to the database Hotel");
            return connection;     
        ...
        search.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(HotelFinal.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) { 
        try {
            ...
            java.util.logging.Logger.getLogger(HotelFinal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new HotelFinal().setVisible(true);
            }
        });
    }
